...
<script type="text/javascript">
	$(function() {
		var url = "<c:url value='/sys/manage/role/allrole'/>";
		$.ajax({
			url : url,
			type : "POST",
			dataType : "JSON",
			success : function(data) {
				...
				$.ajax({
					url : "<c:url value='/sys/manage/role/rolebyuserid?userId=${param.userId}'/>",
					type : "POST",
					dataType : "text",
					success : function(data) {
						data=eval(data);
